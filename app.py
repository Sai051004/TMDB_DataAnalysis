...
# Load movie data
movies = pickle.load(open(r'C:\Users\SAI\OneDrive\Pictures\Desktop\tmdb_dataset2\movie_list.pkl','rb'))
similarity = pickle.load(open(r'C:\Users\SAI\OneDrive\Pictures\Desktop\tmdb_dataset2\similarity.pkl','rb'))
